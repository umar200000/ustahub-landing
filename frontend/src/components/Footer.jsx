  ...
  const footerLinks = {
    uz: {
      ...
      support: { title: 'Yordam', items: [
        ...
        { label: 'Hisobni o\'chirish', href: '/delete-account' },
        { label: 'Aloqa', href: '#' },
      ]},
    },
    ru: {
      ...
      support: { title: 'Помощь', items: [
        ...
        { label: 'Удалить аккаунт', href: '/delete-account' },
        { label: 'Контакты', href: '#' },
      ]},
    },
    en: {
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-6 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <a href="https://www.instagram.com/ustahub.uz/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-gray-800 hover:bg-pink-500/20 flex items-center justify-center text-gray-400 hover:text-pink-400 transition-all">
