...
export default function AdminHowItWorks() {
  return (
    <AdminCrud
      ...
      subtitle="Qadamlar bo'limini boshqarish"
      fields={[
        { name: 'step_number', label: 'Qadam raqami', type: 'number', default: 1 },
        ...
        { name: 'icon', label: 'Icon (search, user-check, calendar, star)', default: 'search' },
        { name: 'sort_order', label: 'Tartib', type: 'number', default: 0 },
      ]}
      columns={[
        { label: '#', field: 'step_number' },
